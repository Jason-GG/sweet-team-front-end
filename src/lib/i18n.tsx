...
type TranslationSet = {
  nav: Record<'home' | 'booths' | 'groups' | 'community' | 'chat' | 'myTown' | 'guide' | 'profile', string>
  topbar: {
    tagline: string
...
const translations: Record<LanguageCode, TranslationSet> = {
  en: {
    ...
    community: {
      title: 'Community',
      subtitle: 'Official booths and personal groups in one place',
      wallTitle: 'Group wall',
      postPlaceholder: 'Share something with this group...',
      post: 'Post',
    },
    guide: {
  ...
  ja: {
    nav: { home: 'ホーム', booths: 'ブース', groups: 'グループ', community: 'コミュニティ', chat: '個別チャット', myTown: 'マイタウン', guide: 'ガイド', profile: 'プロフィール' },
    topbar: {
    ...
    community: { title: 'コミュニティ', subtitle: '公式ブースと個人グループをひとつの場所で', wallTitle: 'グループの投稿', postPlaceholder: 'このグループに共有する内容を入力...', post: '投稿' },
    guide: {
      title: 'あなたの知識コレクション',
  ...
  es: {
    nav: { home: 'Inicio', booths: 'Puestos', groups: 'Grupos', community: 'Comunidad', chat: 'Chat personal', myTown: 'Mi ciudad', guide: 'Guía', profile: 'Perfil' },
    ...
    community: { title: 'Comunidad', subtitle: 'Puestos oficiales y grupos personales en un solo lugar', wallTitle: 'Muro del grupo', postPlaceholder: 'Comparte algo con este grupo...', post: 'Publicar' },
  ...
  hi: {
    nav: { home: 'होम', booths: 'बूथ', groups: 'समूह', community: 'समुदाय', chat: 'निजी चैट', myTown: 'मेरा शहर', guide: 'गाइड', profile: 'प्रोफ़ाइल' },
    ...
    community: { title: 'समुदाय', subtitle: 'आधिकारिक बूथ और व्यक्तिगत समूह एक ही जगह', wallTitle: 'समूह की दीवार', postPlaceholder: 'इस समूह के साथ कुछ साझा करें...', post: 'पोस्ट करें' },
  ...
  zh: {
    nav: { home: '首页', booths: '展位', groups: '群组', community: '社区', chat: '私聊', myTown: '我的社区', guide: '指南', profile: '个人资料' },
    ...
    community: { title: '社区', subtitle: '官方展位和个人群组集中在一处', wallTitle: '群组动态', postPlaceholder: '和这个群组分享一些内容...', post: '发布' },
  ...
  fr: {
    nav: { home: 'Accueil', booths: 'Stands', groups: 'Groupes', community: 'Communauté', chat: 'Chat privé', myTown: 'Ma ville', guide: 'Guide', profile: 'Profil' },
    ...
    community: { title: 'Communauté', subtitle: 'Stands officiels et groupes personnels au même endroit', wallTitle: 'Mur du groupe', postPlaceholder: 'Partagez quelque chose avec ce groupe...', post: 'Publier' },
  ...
  ar: {
    nav: { home: 'الرئيسية', booths: 'الأكشاك', groups: 'المجموعات', community: 'المجتمع', chat: 'دردشة خاصة', myTown: 'مدينتي', guide: 'الدليل', profile: 'الملف الشخصي' },
    ...
    community: { title: 'المجتمع', subtitle: 'الأكشاك الرسمية والمجموعات الشخصية في مكان واحد', wallTitle: 'حائط المجموعة', postPlaceholder: 'شاركي شيئًا مع هذه المجموعة...', post: 'نشر' },
